...
################################################################
# This is a generated script based on design: pl_pcie_rp_msi
#
...
# source pl_pcie_rp_msi_script.tcl
...
set design_name pl_pcie_rp_msi
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set fmc_clk_n [ create_bd_port -dir O -from 0 -to 0 -type clk fmc_clk_n ]
  set fmc_clk_p [ create_bd_port -dir O -from 0 -to 0 -type clk fmc_clk_p ]
  set pcie_perstn [ create_bd_port -dir O -from 0 -to 0 -type rst pcie_perstn ]
  ...
  set_property -dict [list \
    ...
    CONFIG.axibar2pciebar_1 {0x0000000500000000} \
    CONFIG.axibar_num {2} \
...
\
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins xdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net xdma_0_M_AXI_B [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins xdma_0/M_AXI_B]
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_0_M_AXI_B] [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_FPD] [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM1_FPD] [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_net -net xdma_0_axi_ctl_aresetn  [get_bd_pins xdma_0/axi_ctl_aresetn] \
  [get_bd_pins axi_mem_intercon/ARESETN] \
  [get_bd_pins axi_mem_intercon/S00_ARESETN] \
  [get_bd_pins axi_mem_intercon/M00_ARESETN]
  connect_bd_net -net xdma_0_cfg_ltssm_state  [get_bd_pins xdma_0/cfg_ltssm_state] \
  [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net xdma_0_interrupt_out  [get_bd_pins xdma_0/interrupt_out] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net xdma_0_interrupt_out_msix_0  [get_bd_pins xdma_0/interrupt_out_msi_vec0to31] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xdma_0_interrupt_out_msix_1  [get_bd_pins xdma_0/interrupt_out_msi_vec32to63] \
  ...
  assign_bd_address -offset 0x000500000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs xdma_0/S_AXI_B/BAR1] -force
  assign_bd_address -offset 0xA0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs xdma_0/S_AXI_LITE/CTL0] -force
